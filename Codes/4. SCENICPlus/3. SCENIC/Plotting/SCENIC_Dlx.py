...
os.chdir("/faststorage/project/Hypothalamus/SCENIC/Dlx_SCENIC_outs")
scplus_mdata = mudata.read("Dlx_scplusmdata.h5mu")
...
plot = heatmap_dotplot(
    ...
    'ControlAntIDIDTT', 'MutantAntIDIDTT',
...
plot.save("Dlx_heatmap_plot_extended2.eps", limitsize=False)