...
os.chdir("/faststorage/project/Hypothalamus/SCENIC/Lhx2_SCENIC_outs")
scplus_mdata = mudata.read("Lhx2_scplusmdata.h5mu")
...
plot.save("Lhx2_heatmap_plot_extended2.eps", limitsize=False)