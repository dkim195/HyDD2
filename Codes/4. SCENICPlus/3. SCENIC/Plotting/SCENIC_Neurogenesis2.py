...
genes = ['Dlx1_direct_+/+_(331g)',
         'Dlx2_direct_+/+_(286g)',
         'Isl1_direct_+/+_(549g)',
         'Lhx1_direct_+/+_(194g)',
         'Lhx2_direct_+/+_(254g)',
         'Nkx2-1_direct_+/+_(459g)',
         'Nkx2-2_direct_+/+_(138g)']
...
plt.tight_layout()
fig.savefig("neurogenesis_scenic_violin.eps", format='eps', bbox_inches='tight')
...
plt.tight_layout()
fig.savefig("neurogenesis_scenic_violin2.eps", format='eps', bbox_inches='tight')
