...
os.chdir("/faststorage/project/Hypothalamus/SCENIC/Isl1_SCENIC_outs")
scplus_mdata = mudata.read("Isl1_scplusmdata.h5mu")
...
plot.save("Isl1_heatmap_plot_extended2.eps", limitsize=False)