...
os.chdir("/faststorage/project/Hypothalamus/SCENIC/neurogenesis_SCENIC_outs")
scplus_mdata = mudata.read("neurogenesis_scplusmdata.h5mu")
...
plot.save("neurogenesis_heatmap_plot_extended2.eps", limitsize=False)