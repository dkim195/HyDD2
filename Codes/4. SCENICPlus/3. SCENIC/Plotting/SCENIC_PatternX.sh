...
python /faststorage/project/Hypothalamus/script/scenicscript/SCENIC_Patternx.py >> /faststorage/project/Hypothalamus/script/scenicscript/SCENIC_Pattern_Output.log 2>&1
