...
os.chdir("/faststorage/project/Hypothalamus/SCENIC/Foxd1_SCENIC_outs")
scplus_mdata = mudata.read("Foxd1_scplusmdata.h5mu")
...
def heatmap_dotplot(
    ...
    # Repressor/Activator determination and filter out unknowns
    plotting_df["repressor_activator"] = plotting_df[feature_name_key].apply(
        lambda x: "activator" if "+/+" in x else ("repressor" if "-/+" in x else "unknown"))
    plotting_df = plotting_df[plotting_df["repressor_activator"] != "unknown"]  # Remove unknowns
    # Order data
...
plot = heatmap_dotplot(
    ...
    group_variable_order = ['ControlAntIDID', 'MutantAntIDID',
    'ControlARCVMH', 'MutantARCVMH',
    'ControlLH', 'MutantLH',
    'ControlMMN', 'MutantMMN',
    'ControlNPCGlial', 'MutantNPCGlial',
    'ControlPOASCN', 'MutantPOASCN',
    'ControlPMN', 'MutantPMN',
    'ControlPreThal', 'MutantPreThal',
    'ControlPreThalID', 'MutantPreThalID',
    'ControlSMN', 'MutantSMN',
    'ControlSstNpy', 'MutantSstNpy',
    'ControlNeuralProNeurog2', 'MutantNeuralProNeurog2'],
    eRegulon_metadata_key="extended_e_regulon_metadata",
    color_feature_key="Gene_signature_name",
    size_feature_key="Region_signature_name",
    feature_name_key="eRegulon_name",
    sort_data_by="extended_gene_based_AUC",
    scale_size_matrix=True,
    scale_color_matrix=True,
    orientation="horizontal",
    figsize=(80, 10)  # Adjust size as needed
)
plot.save("Foxd1_heatmap_plot_extended2.eps", limitsize=False)