...
# Set up logging
logging.basicConfig(filename="pycistopic_PATTERN.log", level=logging.INFO,
...
matrix_path = "PATTERN_count_matrix.feather"
...
cell_annotation_path = "PATTERN_cell_annotation.tsv"
...
pickle.dump(cisTopic_obj, open(os.path.join(out_dir, "PATTERN_obj.pkl"), "wb"))
...
pickle.dump(models, open(os.path.join(out_dir, "PATTERN_models.pkl"), "wb"))
