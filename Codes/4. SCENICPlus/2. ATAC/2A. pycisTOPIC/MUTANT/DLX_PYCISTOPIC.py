...
# Set up logging
logging.basicConfig(filename="pycistopic_DLX.log", level=logging.INFO,
...
matrix_path = "Mutant_Dlx_count_matrix.feather"
...
cell_annotation_path = "Mutant_Dlx_cell_annotation.tsv"
...
pickle.dump(cisTopic_obj, open(os.path.join(out_dir, "Dlx_obj.pkl"), "wb"))
...
pickle.dump(models, open(os.path.join(out_dir, "Dlx_models.pkl"), "wb"))
...
X_umap = pd.read_csv("Mutant_Dlx_cell_embeddings.csv", index_col=0)
