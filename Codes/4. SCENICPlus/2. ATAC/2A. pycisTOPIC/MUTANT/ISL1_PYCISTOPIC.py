...
# Set up logging
logging.basicConfig(filename="pycistopic_Isl1.log", level=logging.INFO,
...
matrix_path = "Mutant_Isl1_count_matrix.feather"
...
cell_annotation_path = "Mutant_Isl1_cell_annotation.tsv"
...
pickle.dump(cisTopic_obj, open(os.path.join(out_dir, "Isl1_obj.pkl"), "wb"))
...
pickle.dump(models, open(os.path.join(out_dir, "Isl1_models.pkl"), "wb"))
...
X_umap = pd.read_csv("Mutant_Isl1_cell_embeddings.csv", index_col=0)
