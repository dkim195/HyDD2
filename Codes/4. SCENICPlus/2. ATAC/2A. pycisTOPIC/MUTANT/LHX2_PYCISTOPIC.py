...
# Set up logging
logging.basicConfig(filename="pycistopic_Lhx2.log", level=logging.INFO,
...
matrix_path = "Mutant_Lhx2_count_matrix.feather"
...
cell_annotation_path = "Mutant_Lhx2_cell_annotation.tsv"
...
pickle.dump(cisTopic_obj, open(os.path.join(out_dir, "Lhx2_obj.pkl"), "wb"))
...
pickle.dump(models, open(os.path.join(out_dir, "Lhx2_models.pkl"), "wb"))
...
X_umap = pd.read_csv("Mutant_Lhx2_cell_embeddings.csv", index_col=0)
