...
#SBATCH --job-name=neurogenesis_CISTARGET
#SBATCH --mail-user=tkim@dandrite.au.dk


#neurogenesis TO FILE NAME
...
echo "Running Python script: neurogenesis_Consensus.py"
python /faststorage/project/Hypothalamus/script/scenicscript/NEUROGENESIS_Consensus.py >> /faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/neurogenesis_Consensus.log 2>&1
...
REGION_BED="/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/neurogenesis/neurogenesis_outs/consensus_peak_calling/consensus_regions.bed"
CTRL_OUT_DIR="/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/neurogenesis/neurogenesis_outs"
FASTA_FILE="${CTRL_OUT_DIR}/mm10.neurogenesis.fa"

# Ensure output directory exists
mkdir -p ${CTRL_OUT_DIR}

echo "Processing neurogenesis..."
echo "Creating FASTA for neurogenesis without padding..."
...
echo "Creating cistarget motif databases for neurogenesis..."
