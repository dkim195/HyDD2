...
try:
    os.chdir("/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/OBJECT")
    out_dir = "OBJECT_outs"
    create_dir(out_dir)
except Exception as e:
...
cell_data_path = "/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/OBJECT/OBJECT_cell_annotation.tsv"
...
# Sanitize the Cluster_Pass2 column specifically
