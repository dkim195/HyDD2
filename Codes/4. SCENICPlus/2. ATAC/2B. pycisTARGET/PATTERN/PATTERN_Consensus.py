...
try:
    os.chdir("/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/PATTERN")
    out_dir = "PATTERN_outs"
    create_dir(out_dir)
except Exception as e:
...
fragments_dict = {
    "TK72": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TK72/fragments.tsv.gz",
    "TK91": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TK91/fragments.tsv.gz",
    "TK43": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TK43/fragments.tsv.gz",
    "TK47": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TK47/fragments.tsv.gz",
    "TK73": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TK73/fragments.tsv.gz",
    "TK95": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TK95/fragments.tsv.gz",
    "TK74": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TK74/fragments.tsv.gz",
    "TK75": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TK75/fragments.tsv.gz",
    "TKC4": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TKC4/fragments.tsv.gz"

}
logging.info("Fragments dictionary defined")

# Check and load cell annotation data
cell_data_path = "/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/PATTERN/PATTERN_cell_annotation.tsv"
