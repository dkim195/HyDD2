...
#SBATCH --job-name=PATTERN_CISTARGET
#SBATCH --mail-user=tkim@dandrite.au.dk


#PATTERN TO FILE NAME
...
echo "Running Python script: PATTERN_Consensus.py"
python /faststorage/project/Hypothalamus/script/scenicscript/PATTERN_Consensus.py >> /faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/PATTERN_Consensus.log 2>&1
...
REGION_BED="/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/PATTERN/PATTERN_outs/consensus_peak_calling/consensus_regions.bed"
CTRL_OUT_DIR="/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/PATTERN/PATTERN_outs"
FASTA_FILE="${CTRL_OUT_DIR}/mm10.PATTERN.fa"

# Ensure output directory exists
mkdir -p ${CTRL_OUT_DIR}

echo "Processing PATTERN..."
echo "Creating FASTA for PATTERN without padding..."
...
echo "Creating cistarget motif databases for PATTERN..."
