...
try:
    os.chdir("/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/ISL1")
    out_dir = "Isl1_outs"
    create_dir(out_dir)
except Exception as e:
...
fragments_dict = {
    ...
    "TK44": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TK44/fragments.tsv.gz",
    "TK48": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TK48/fragments.tsv.gz"
}
logging.info("Fragments dictionary defined")

# Check and load cell annotation data
cell_data_path = "/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/ISL1/Mutant_Isl1_cell_annotation.tsv"
