...
#SBATCH --job-name=Isl1_CISTARGET
...
echo "Running Python script: Isl1_Consensus.py"
python /faststorage/project/Hypothalamus/script/scenicscript/Isl1_Consensus.py >> /faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/Isl1_Consensus.log 2>&1
...
REGION_BED="/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/ISL1/Isl1_outs/consensus_peak_calling/consensus_regions.bed"
CTRL_OUT_DIR="/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/ISL1/Isl1_outs"
FASTA_FILE="${CTRL_OUT_DIR}/mm10.Isl1.fa"

# Ensure output directory exists
mkdir -p ${CTRL_OUT_DIR}

echo "Processing Isl1 ..."
echo "Creating FASTA for Isl1 without padding..."
...
echo "Creating cistarget motif databases for Isl1L..."
