...
fragments_dict = {
    ...
    "TK55": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TK55/fragments.tsv.gz",
    "TK56": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TK56/fragments.tsv.gz"
}
logging.info("Fragments dictionary defined")

# Check and load cell annotation data
cell_data_path = "/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/FOXD1/Mutant_Foxd1_cell_annotation.tsv"
