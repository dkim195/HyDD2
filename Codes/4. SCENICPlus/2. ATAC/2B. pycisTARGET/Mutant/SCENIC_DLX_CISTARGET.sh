...
echo "Running Python script: DLX_Consensus.py"
python /faststorage/project/Hypothalamus/script/scenicscript/Dlx_Consensus.py >> /faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/Dlx_Consensus.log 2>&1
...
REGION_BED="/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/DLX/Dlx_outs/consensus_peak_calling/consensus_regions.bed"
CTRL_OUT_DIR="/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/DLX/Dlx_outs"
FASTA_FILE="${CTRL_OUT_DIR}/mm10.Dlx.fa"

# Ensure output directory exists
mkdir -p ${CTRL_OUT_DIR}

echo "Processing Dlx..."
echo "Creating FASTA for DLx without padding..."
...
echo "Creating cistarget motif databases for Dlx..."
