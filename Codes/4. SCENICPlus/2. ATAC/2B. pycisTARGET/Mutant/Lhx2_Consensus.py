...
try:
    os.chdir("/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/LHX2")
    out_dir = "Lhx2_outs"
    create_dir(out_dir)
except Exception as e:
...
fragments_dict = {
    ...
    "TK45": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TK45/fragments.tsv.gz",
    "TK46": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TK46/fragments.tsv.gz"
}
logging.info("Fragments dictionary defined")

# Check and load cell annotation data
cell_data_path = "/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/LHX2/Mutant_Lhx2_cell_annotation.tsv"
...
cell_data['Clusters'] = cell_data['Clusters'].apply(sanitize_filename)
