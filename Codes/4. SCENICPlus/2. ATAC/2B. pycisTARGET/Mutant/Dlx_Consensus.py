...
try:
    os.chdir("/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/DLX")
    out_dir = "Dlx_outs"
    create_dir(out_dir)
except Exception as e:
...
fragments_dict = {
    ...
    "TK57": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TK57/fragments.tsv.gz",
    "TK58": "/faststorage/project/Hypothalamus/data/scATAC/Fragments/TK58/fragments.tsv.gz"
}
logging.info("Fragments dictionary defined")

# Check and load cell annotation data
cell_data_path = "/faststorage/project/Hypothalamus/SCENIC/ATAC/OUTPUT/DLX/Mutant_Dlx_cell_annotation.tsv"
