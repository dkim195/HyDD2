...
####Dlx_scATAC####
#plot
load(file = "scATAC/Files/Dlx_Mutant_adjusted_Final.Robj")
...
png(filename = "Figures/Fig3/Dlx/DEG_Dlx_scATAC_raw.png", width = 900, height = 900)
print(p)
dev.off()

#UMAP
p <- DimPlot(Mutant_adjusted, label = , cols = group, raster = F, split.by = "Genotype")+ NoLegend() + NoAxes()
png(filename = "Figures/Fig3/Dlx/DEG_Dlx_scATAC.png", width = 2400, height = 1200, res = 300)
print(p)
dev.off()
...
#from DEG
genes <- c("Lhx8", "Prdm12", "D930028M14Rik", "Gabra2", "Pnoc", "9230102O04Rik", 
           "Gata3", "Gata2", "Rpp25", "Pcp4", "B230323A14Rik", "Foxb1", 
           "Vsnl1", "Nxph4", "Pclaf", "Smim27", "Gm32061", "Mt3", "Mrpl58", 
           "Gsx1", "Ascl1", "Stk33", "Rgs16", "Helt", "Tal2", "Gadd45g", 
           "Gsx2", "Neurog1", "Rspo3", "Sstr2", "Neurog2", "Hmx3", "Hmx2", 
           "Vgll2", "Syt6", "RP24-236C17.2", "Calb1", "Cartpt", "Rxrg", 
           "Otp", "Crtac1", "Rgs4", "Sncg", "Nkx6-2", "Sst", "Sp8", "Meis2", 
           "Dlx6os1", "Dlx6", "C130021I20Rik", "Barhl1", "Lmx1b", "Nr4a2", 
           "Irx3", "Pou4f1", "Nr0b1", "Nr5a1", "Pmch", "Chchd10", "Nup62cl", 
           "Sox14")
...
png(filename = "Figures/Fig3/Dlx/scATAC_heatmap_Dlx_DEG_Italic.png", width = 3500, height = 1800, res = 300)
print(heatmp)
dev.off()
#newnames <- lapply(
...
#              color = colorRampPalette(c("blue", "white", "red"))(50),
#              labels_row = as.expression(newnames))
#png(filename = "Figures/Fig3/Dlx/scATAC_heatmap_Dlx_DEG_Italic.png", width = 3000, height = 2000)
#print(p)
#dev.off()
...
#              cluster_cols = F, cellwidth = 10, cellheight = 10, angle_col = 45,
#              color = colorRampPalette(c("blue", "white", "red"))(50))
#png(filename = "Figures/Fig3/Dlx/scATAC_heatmap_Dlx_DEG.png", width = 3000, height = 2000)
#print(p)
#dev.off()
...
if (nrow(data_matrix) > 1) {
  ...
  p4 <- pheatmap(clean_data, fontsize = 8,scale = "column",
                 ...
                 color = colorRampPalette(c("blue", "white", "red"))(50),
                 labels_row = as.expression(newnames))
  png(filename = "Figures/Fig3/Dlx/scATAC_heatmap_Dlx_PatternGene_Italic.png",
...
#                 cluster_cols = FALSE, cellwidth = 10, cellheight = 10, angle_col = 45,
#                 color = colorRampPalette(c("blue", "white", "red"))(50))
#  png(filename = "Figures/Fig3/Dlx/scATAC_heatmap_Dlx_PatternGene.png",
#      width = 3000, height = 2000)
#  print(p4)
#  dev.off()
#} else {
...
gplot <- pl1[[1]] & 
  ...
  DarkTheme()
ggsave(filename = "Figures/Fig3/Dlx/scATAC_densityheatmap_Dlx.eps",
...
#  coord_fixed()
#png(filename = "Figures/Fig3/Dlx/scATAC_densityheatmap_Dlx.png", width = 1200, height = 1000)
#print(p)
#dev.off()
...
ggsave(filename = "Figures/Fig3/Dlx/scATAC_densitypercentage_Dlx.eps",
       plot = gplot, width = 20, height = 10, units = "in", device = cairo_ps)

#png(filename = "Figures/Fig3/Dlx/scATAC_densitypercentage_Dlx.png", width = 1200, height = 1000)
#print(p)
#dev.off()
