...
png(filename = "Figures/Fig3/Lhx1/DEG_Lhx1_scRNA_raw.png", width = 900, height = 900)
print(p)
dev.off()

#UMAP
p <- DimPlot(Mutant, label = , cols = group, raster = F, split.by = "Genotype")+ NoLegend() + NoAxes()
png(filename = "Figures/Fig3/Lhx1/DEG_Lhx1_scRNA.png", width = 2400, height = 1200, res = 300)
print(p)
dev.off()
...
write.csv(markers, file = "Figures/Fig3/Lhx1/DEG_Lhx1_scRNA_Cluster_Genotype.csv")

#heatmap
library(pheatmap)
lists <- read.csv(file = "Figures/Fig3/Lhx1/DEG_Lhx1_scRNA_Cluster_Genotype.csv",
...
#from DEG
genes <- c("Lhx6", "Prdm12", "Col25a1", "Gabrb1", "Zfp385b", "Pax7", "Vsnl1", 
           "Pcp4", "Tmem132b", "B230323A14Rik", "Robo3", "Sgol2a", "2810417H13Rik", 
           "Sgol1", "Fam64a", "Casc5", "Dapk2", "Gsx1", "Helt", "Gm11549", 
           "Gadd45g", "Jakmip3", "Tal2", "Gata2", "Neurog1", "Eya2", "Sstr2", 
           "Neurod2", "Eomes", "Tfap2a", "Rspo3", "Tbr1", "Dkk2", "Msx1", 
           "Hmx2", "Hmx3", 
           "Vgll2", "Syt6", "Calb1", "Rrad", "Trh", "Cartpt", "Sncg", "Otp", 
           "Chac1", "Calcr", "Nkx6-2", "Unc13c", "Sst", "Sp8", "Meis2", 
           "2700033N17Rik", "G630016G05Rik", "Slc30a3", "Irx6", "C130021I20Rik", 
           "AC119932.1", "Lmx1b", "Nr4a2", "Pmch", "Chchd10", "Nup62cl", 
           "Nr0b1", "Nr5a1", "Ar", "Sox14")
...
png(filename = "Figures/Fig3/Lhx1/heatmap_Lhx1_DEG_Italic.png", width = 3600, height = 1800, res = 300)
print(heatmp)
dev.off()
#newnames <- lapply(
...
#                   color = colorRampPalette(c("blue", "white", "red"))(50),
#                   labels_row = as.expression(newnames))
#png(filename = "Figures/Fig3/Lhx1/heatmap_Lhx1_DEG_Italic.png", width = 3000, height = 2000)
#print(p)
#dev.off()
...
#                   cluster_cols = F, cellwidth = 10, cellheight = 10, angle_col = 45,
#                   color = colorRampPalette(c("blue", "white", "red"))(50))
#png(filename = "Figures/Fig3/Lhx1/heatmap_Lhx1_DEG.png", width = 3000, height = 2000)
#print(p)
#dev.off()
...
heatmp <- pheatmap(scaled_transposed_matrix, fontsize = 8,scale = "column",
                   ...
                   color = colorRampPalette(c("blue", "white", "red"))(50),
                   labels_row = as.expression(newnames))
png(filename = "Figures/Fig3/Lhx1/heatmap_Lhx1_PatternGene_Italic.png", width = 8000, height = 1800, res = 300)
print(heatmp)
dev.off()
...
#              color = colorRampPalette(c("blue", "white", "red"))(50),
#              labels_row = as.expression(newnames))
#png(filename = "Figures/Fig3/Lhx1/heatmap_Lhx1_PatternGene_Italic.png", width = 3000, height = 2000)
#print(p)
#dev.off()
...
#              cluster_cols = F, cellwidth = 10, cellheight = 10, angle_col = 45,
#              color = colorRampPalette(c("blue", "white", "red"))(50))
#png(filename = "Figures/Fig3/Lhx1/heatmap_Lhx1_PatternGene.png", width = 3000, height = 2000)
#print(p)
#dev.off()
...
gplot <- pl1[[1]] & 
  ...
  DarkTheme()
ggsave(filename = "Figures/Fig3/Lhx1/densityheatmap_Lhx1.eps",
...
#  coord_fixed()
#png(filename = "Figures/Fig3/Lhx1/densityheatmap_Lhx1.png", width = 1200, height = 1000)
#print(p)
#dev.off()
...
ggsave(filename = "Figures/Fig3/Lhx1/densitypercentage_Lhx1.eps",
       plot = gplot, width = 20, height = 10, units = "in", device = cairo_ps)
#png(filename = "Figures/Fig3/Lhx1/densitypercentage_Lhx1.png", width = 1200, height = 1000)
#print(p)
#dev.off()
