...
DimPlot(Mutant, group.by = "Cluster_Pass2")
...
png(filename = "Figures/Fig3/Isl1/DEG_Isl1_scRNA_raw.png", width = 900, height = 900)
print(p)
dev.off()

#UMAP
p <- DimPlot(Mutant, label = , cols = group, raster = F, split.by = "Genotype")+ NoLegend() + NoAxes()
png(filename = "Figures/Fig3/Isl1/DEG_Isl1_scRNA.png", width = 2400, height = 1200, res = 300)
print(p)
dev.off()
...
write.csv(markers, file = "Figures/Fig3/Isl1/DEG_Isl1_scRNA_Cluster_Genotype.csv")

#heatmap
library(pheatmap)
lists <- read.csv(file = "Figures/Fig3/Isl1/DEG_Isl1_scRNA_Cluster_Genotype.csv",
...
png(filename = "Figures/Fig3/Isl1/heatmap_Isl1_DEG_Italic.png", width = 3500, height = 1800, res = 300)
print(heatmp)
dev.off()
#newnames <- lapply(
...
#              color = colorRampPalette(c("blue", "white", "red"))(50),
#              labels_row = as.expression(newnames))
#png(filename = "Figures/Fig3/Isl1/heatmap_Isl1_DEG_Italic.png", width = 3000, height = 2000)
#print(p)
#dev.off()
...
#              cluster_cols = F, cellwidth = 10, cellheight = 10, angle_col = 45,
#              color = colorRampPalette(c("blue", "white", "red"))(50))
#png(filename = "Figures/Fig3/Isl1/heatmap_Isl1_DEG.png", width = 3000, height = 2000)
#print(p)
#dev.off()
...
heatmp <- pheatmap(scaled_transposed_matrix, fontsize = 8,scale = "column",
                   ...
                   color = colorRampPalette(c("blue", "white", "red"))(50),
                   labels_row = as.expression(newnames))
png(filename = "Figures/Fig3/Isl1/heatmap_Isl1_PatternGene_Italic.png", width = 8000, height = 1800, res = 300)
print(heatmp)
dev.off()
#newnames <- lapply(
#  rownames(Avg.Scaling$SCT[valid_genes,]),
...
#              color = colorRampPalette(c("blue", "white", "red"))(50),
#              labels_row = as.expression(newnames))
#png(filename = "Figures/Fig3/Isl1/heatmap_Isl1_PatternGene_Italic.png", width = 3000, height = 2000)
#print(p)
#dev.off()
...
#              cluster_cols = F, cellwidth = 10, cellheight = 10, angle_col = 45,
#              color = colorRampPalette(c("blue", "white", "red"))(50))
#png(filename = "Figures/Fig3/Isl1/heatmap_Isl1_PatternGene.png", width = 3000, height = 2000)
#print(p)
#dev.off()
...
gplot <- pl1[[1]] & 
  ...
  DarkTheme()
ggsave(filename = "Figures/Fig3/Isl1/densityheatmap_Isl1.eps",
...
#  coord_fixed()
#png(filename = "Figures/Fig3/Isl1/densityheatmap_Isl1.png", width = 1200, height = 1000)
#print(p)
#dev.off()
...
ggsave(filename = "Figures/Fig3/Isl1/densitypercentage_Isl1.eps",
       plot = gplot, width = 20, height = 10, units = "in", device = cairo_ps)
#png(filename = "Figures/Fig3/Isl1/densitypercentage_Isl1.png", width = 1200, height = 1000)
#print(p)
#dev.off()
