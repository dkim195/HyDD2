...
load(file = "scATAC/Foxd1_Mutant_adjusted_Final.Robj")
...
save(Mutant_adjusted, file = "scATAC/Foxd1_Mutant_adjusted_Final2.Robj")
...
region_motif_map <- list(
  "REGION1" = "MA0725.1", "REGION2" = "MA0726.1", "REGION3" = "MA0613.1",
  "REGION4" = "MA0751.1", "REGION5" = "MA0696.1")
...
for (region in names(region_motif_map)) {
  ...
  filename <- paste0(output_dir, "Foxd1_", region, "_", motif, ".png")
...
MOTIFNAMES <- c("MA0725.1", "MA0726.1", "MA0613.1", "MA0751.1", "MA0696.1")
...
filename <- paste0(output_dir, "Foxd1_MOTIFLIST.png")
