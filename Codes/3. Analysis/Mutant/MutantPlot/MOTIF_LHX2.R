...
load(file = "scATAC/Lhx2_Mutant_adjusted_Final.Robj")
...
save(Mutant_adjusted, file = "scATAC/Lhx2_Mutant_adjusted_Final2.Robj")
...
region_motif_map <- list(
  "REGION1" = "MA0635.1", "REGION2" = "MA0668.1", "REGION3" = "MA0690.1", 
  "REGION4" = "MA1518.1", "REGION5" = "MA0800.1", "REGION6" = "MA1565.1",
  "REGION7" = "MA0616.2", "REGION8" = "MA0711.1", "REGION9" = "MA0802.1", "REGION10" = "MA0701.2", "REGION11" = "MA0630.1",
  "REGION12" = "MA1421.1", "REGION13" = "MA0523.1", "REGION14" = "MA0768.1", "REGION15" = "MA0875.1")                                   
...
for (region in names(region_motif_map)) {
  ...
  filename <- paste0(output_dir, "Lhx2_", region, "_", motif, ".png")
...
MOTIFNAMES <- c("MA0635.1", "MA0668.1", "MA0690.1", "MA1518.1", "MA0800.1", "MA1565.1", "MA0616.2",
                "MA0711.1", "MA0802.1", "MA0701.2", "MA0630.1", "MA1421.1", "MA0523.1", "MA0768.1", "MA0875.1")
...
filename <- paste0(output_dir, "Lhx2_MOTIFLIST.png")
